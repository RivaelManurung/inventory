					...
					<div class="dropdown-menu w-100" data-color-theme="light">
						...
						<div class="dropdown-menu-scrollable-lg">
							...
							<div class="dropdown-item cursor-pointer">
								<div class="me-3">
									<img src="assets/images/users/face3.jpg" class="w-32px h-32px rounded-pill" alt="">
								</div>

								<div class="d-flex flex-column flex-grow-1">
									<div class="fw-semibold">Christine Johnson</div>
							...
							<div class="dropdown-item cursor-pointer">
								<div class="me-3">
									<img src="assets/images/users/face24.jpg" class="w-32px h-32px rounded-pill" alt="">
								</div>

								<div class="d-flex flex-column flex-grow-1">
									<div class="fw-semibold">Clinton Sparks</div>
							...
							<div class="dropdown-item cursor-pointer">
								...
								<div class="d-flex flex-column flex-grow-1">
									<div class="fw-semibold">Adobe Inc.</div>
							...
							<div class="dropdown-item cursor-pointer">
								...
								<div class="d-flex flex-column flex-grow-1">
									<div class="fw-semibold">Holiday-Inn</div>
							...
							<div class="dropdown-item cursor-pointer">
								...
								<div class="d-flex flex-column flex-grow-1">
									<div class="fw-semibold">ING Group</div>
